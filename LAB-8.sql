...
SELECT MIN(SALES_AMOUNT) FROM SALES_DATA
GROUP BY REGION,YEAR

--5. Count of Products Sold by Region
SELECT COUNT(PRODUCT) FROM SALES_DATA
GROUP BY REGION
...
SELECT YEAR,MIN(PRODUCT) FROM SALES_DATA
GROUP BY YEAR
...
SELECT COUNT(PRODUCT),YEAR FROM SALES_DATA
GROUP BY REGION,YEAR
...
SELECT COUNT(PRODUCT),REGION,PRODUCT FROM SALES_DATA
